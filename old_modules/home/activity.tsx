        ...
        <div className="flex flex-col h-full -mx-2">
            ...
            {tooltip && typeof document !== 'undefined' && createPortal(
                (() => {
                    ...
                    return (
                        <div
                            className={`fixed z-50 w-fit min-w-max rounded-lg border bg-background p-3 text-sm text-foreground transition-opacity duration-500 pointer-events-none ${tooltip.visible ? 'opacity-100' : 'opacity-0'}`}
                            style={{
                                left: tooltip.x,
                                top: tooltip.y,
                                transform
