                ...
                <div className="flex items-center justify-between gap-4 py-3">
                    ...
                    <Popover>
                        <PopoverTrigger asChild>
                            <button
                                type="button"
                                className="w-64 min-h-9 rounded-xl border border-input bg-background px-3 py-2 text-left text-xs transition-[color,box-shadow] outline-hidden hover:bg-muted/40"
                        ...
                        <PopoverContent className="w-[320px] space-y-2 rounded-2xl p-3 bg-popover/95 backdrop-blur-xl border border-border shadow-xl">
                            <Input
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <TooltipProvider>
                            <Tooltip>
                                ...
                                <TooltipContent>
                                    <span className="text-xs">{t('groupHealth.description')}</span>
                                </TooltipContent>
                            </Tooltip>
                        </TooltipProvider>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <TooltipProvider>
                            <Tooltip>
                                ...
                                <TooltipContent>
                                    <span className="text-xs">{t('wsUpgrade.description')}</span>
                                </TooltipContent>
                            </Tooltip>
                        </TooltipProvider>
                    </div>
