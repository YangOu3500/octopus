...
import { BarChart3, Gauge, Layers3, Zap, type LucideIcon } from 'lucide-react';
...
function SummaryCard({
    ...
    return (
        ...
        >
            ...
            <div className="mt-5 text-sm font-medium opacity-90">{label}</div>
            <div className="mt-2 text-3xl font-semibold tabular-nums tracking-normal">{value}</div>
            <div className={cn(
