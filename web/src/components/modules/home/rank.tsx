...
export function Rank() {
            ...
            <div className="space-y-3 max-h-[300px] overflow-y-auto">
                {channels.map((channel, index) => {
                    ...
                    return (
                        <div
                            key={channel.raw.id}
                            className="flex items-center gap-3 rounded-lg p-3 transition-colors hover:bg-accent/5"
                        >
    ...
    return (
        <div className="rounded-lg bg-card text-card-foreground border-card-border border p-4 shadow-sm">
